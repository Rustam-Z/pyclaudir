...
| Tool count | 4 | ~40 | 18 MCP + 3 built-in (WebFetch, WebSearch, Agent). Claude Code built-ins not on either allow/deny list (Grep, Glob, ToolSearch, Skill, ListMcpResourcesTool) are implicitly reachable by both the agent and its subagents. |
